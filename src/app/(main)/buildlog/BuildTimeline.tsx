              ...
              <div className="w-1/2 flex justify-center">
                <div className="flex flex-col items-center">
                  <motion.div
                    ...
                    className={`w-10 h-10 rounded-full cursor-pointer flex items-center justify-center z-10 mb-2
        ${selectedMilestone === milestone.id ? "bg-blue-600" : "bg-gray-400"}`}
                  >
              ...
              {/* Timeline Content */}
              <motion.div
                className="w-1/2 p-4 rounded-lg shadow-md bg-white"
                initial={{ opacity: 0.9 }}
              ...
              >
                ...
                <div
                  className="relative w-full h-48 mb-3 overflow-hidden rounded cursor-pointer"
                  onClick={() =>
