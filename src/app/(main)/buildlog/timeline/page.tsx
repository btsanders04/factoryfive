  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Track important events and milestones for your project
        </CardDescription>
      </CardHeader>
      <CardContent>
          ...
          <div className="space-y-6">
            {timelineEvents.map((event) => (
              <div key={event.id} className="relative pl-10">
                {/* Timeline dot */}
                <div className={`absolute left-0 top-1.5 h-8 w-8 rounded-full flex items-center justify-center ${getCategoryColor(event.category)}`}>
                ...
                <div className="bg-card p-4 rounded-lg border shadow-sm">
                  ...
                  <div className="mt-2">
                    <span className={`inline-block px-2 py-1 text-xs rounded-full text-white ${getCategoryColor(event.category)}`}>
                      {event.category}
                    </span>
                  </div>
                </div>
